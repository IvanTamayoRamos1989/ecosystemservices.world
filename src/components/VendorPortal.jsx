...
const MOCK_ASSIGNMENTS = [
  {
    id: 'VER-001',
    assetId: 'AST-001',
    projectName: 'Urban Green Corridors',
    role: 'Licensed Environmental Scientist',
    deliverable: 'GEE Baseline Report: LST + NDVI + Biodiversity Inventory (Signed)',
    deadline: '2026-04-15',
    status: 'Under Review',
    jurisdiction: 'Latin America',
    legalBasis: 'National EIA Framework · IUCN NbS Standard',
  ...
  },
  {
    ...
    projectName: 'Urban Green Corridors',
    role: 'Legal Counsel',
    deliverable: 'Land Access & Permits Documentation (Notarised)',
    deadline: '2026-03-30',
    status: 'Awaiting Upload',
    jurisdiction: 'Latin America',
    legalBasis: 'Municipal Land Use Framework',
