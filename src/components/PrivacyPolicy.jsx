  ...
  return (
    <section id="privacy" className="py-24 md:py-32">
      <div className="max-w-3xl mx-auto px-6">
        <span className="text-accent text-sm tracking-wider uppercase">Legal</span>
        <h2 className="text-3xl md:text-4xl font-bold mt-3 mb-8">Privacy Policy</h2>

        <div className="space-y-8 text-gray-400 text-sm leading-relaxed">
          <div>
            <h3 className="text-white font-semibold text-base mb-3">1. Data Controller</h3>
            <p>
          ...
          <div>
            <h3 className="text-white font-semibold text-base mb-3">2. Data We Collect</h3>
          ...
          <div>
            <h3 className="text-white font-semibold text-base mb-3">3. Purpose & Legal Basis</h3>
            <p className="mb-2">We process your data for the following purposes:</p>
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li><strong className="text-white">Contact inquiries</strong> — to respond to your requests (legal basis: legitimate interest / pre-contractual measures)</li>
              <li><strong className="text-white">Analytics</strong> — to understand website usage and improve our services (legal basis: consent)</li>
              <li><strong className="text-white">Legal compliance</strong> — to meet our obligations under applicable law</li>
            </ul>
          </div>

          <div>
            <h3 className="text-white font-semibold text-base mb-3">4. Data Sharing</h3>
            <p>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li><strong className="text-white">Essential cookies</strong> — required for site functionality (e.g., cookie consent preference)</li>
              <li><strong className="text-white">Analytics cookies</strong> — used only with your consent to understand site traffic</li>
            </ul>
            <p className="mt-2">
          ...
          <div>
            <h3 className="text-white font-semibold text-base mb-3">6. Data Retention</h3>
            <p>
          ...
          <div>
            <h3 className="text-white font-semibold text-base mb-3">7. Your Rights</h3>
          ...
          <div>
            <h3 className="text-white font-semibold text-base mb-3">8. Contact</h3>
            <p>
              For data protection inquiries, contact us via the{' '}
              <a href="#contact" className="text-accent hover:underline">contact form</a> or
